...
#python new_ik_pdf_downloader.py --links links.txt --outdir pdfs --processed downloaded.txt --failures failures.txt --delay 1.2
...
HEADERS = {
    "User-Agent": "IK-ResearchBot/1.2 (+contact: your-email@example.com)"
}
